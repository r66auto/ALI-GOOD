...
class CAR(Platforms):
  ...
  ESCAPE_MK4_23 = FordPlatformConfig(
    ...
    [
      ...
      FordCarInfo("Ford Kuga 2023-24", "Adaptive Cruise Control with Lane Centering"),
      FordCarInfo("Ford Kuga Hybrid 2023-24", "Adaptive Cruise Control with Lane Centering"),
      FordCarInfo("Ford Kuga Plug-in Hybrid 2023-24", "Adaptive Cruise Control with Lane Centering"),
    ],
...
CANFD_CAR = {CAR.F_150_MK14, CAR.F_150_LIGHTNING_MK1, CAR.MUSTANG_MACH_E_MK1, CAR.ESCAPE_MK4_23}
